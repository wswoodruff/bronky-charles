...
const bronkyFart = () => {
    ...
    const shakeFartSettings = {
        ...
        raspberry: {
            shakeNameChoices: 'shake-crazy',
            duration: 2000
        },
        trumpet: {
            shakeNameChoices: ['shake-hard', 'shake-horizontal'],
            duration: 1400
        },
        windy: {
            shakeNameChoices: 'shake-hard',
            duration: 5500
        }
    };
